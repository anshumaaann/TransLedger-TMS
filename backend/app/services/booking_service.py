...
class BookingService:
    ...
    def _generate_booking_number(self) -> str:
        ...
        latest = bookings[0].booking_number
    ...
    def create_booking(self, booking_data: BookingCreate):
        ...
        broker = self.broker_repo.get_by_id(
        ...
        loading = self.location_repo.get_by_id(
        ...
        unloading = self.location_repo.get_by_id(
    ...
    def update_booking(
        ...
        updated_data = booking_data.model_dump(exclude_unset=True)
