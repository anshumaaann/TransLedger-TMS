...
class Booking(Base):
    ...
    loading_site_id: Mapped[uuid.UUID] = mapped_column(
    ...
    unloading_site_id: Mapped[uuid.UUID] = mapped_column(
    ...
    # Cash received after the booking was created.  Initial money received is
    # kept in customer_advance so old records continue to work correctly.
    customer_paid_amount: Mapped[Decimal] = mapped_column(
        Numeric(12, 2),
        default=Decimal("0.00"),
        nullable=False,
    )

    # TDS is tax the customer has withheld from our payment.  It settles part
    # of the customer's outstanding amount even though it is not cash in hand.
    ...
    customer_payment_status: Mapped[str] = mapped_column(
        String(20),
        default="pending",
        nullable=False,
    )
    ...
    # Cash paid to the broker after the booking was created.
    broker_paid_amount: Mapped[Decimal] = mapped_column(
        Numeric(12, 2),
        default=Decimal("0.00"),
        nullable=False,
    )

    broker_payment_status: Mapped[str] = mapped_column(
        String(20),
        default="pending",
        nullable=False,
    )
